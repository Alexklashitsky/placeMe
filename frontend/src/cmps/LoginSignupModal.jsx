        ...
        return (
            <div className="login-signup-modal">
                ...
                <div className="login-header-container">
                    <div className="close-button" onClick={this.onToggleLoginModal}>✖</div>
                ...
                <div className="login-signup-form">
                    ...
                    <div>
                        <div className="clean-link" onClick={this.toggleSignup} >{!isSignup ? 'New user ? continue to Signup' : 'Coming back for more? go back to Login'}</div>
                    </div>
